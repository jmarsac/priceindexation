...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_azur_priceindexation.modules.php
 *	\ingroup    propale
 *	\brief      Fichier de la classe permettant de generer les propales au modele PriceIndexation
 */
...
/**
 *	Class to generate PDF proposal priceindexation
 */
class pdf_azur_priceindexation extends ModelePDFPropales
{
	var $db;
	var $name;
	var $description;
	...
	var $phpmin = array(7,0); // Minimum version of PHP required by module
	...
	function __construct($db)
	{
		...
		{
			$this->posxinitialup-=20;
			$this->posxinitialindex-=20;
			$this->posxcurrentindex-=20;
			$this->posxpicture-=20;
			$this->posxtva-=20;
			$this->posxup-=20;
			$this->posxqty-=20;
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		$outputlangs->load("priceindexation@priceindexation");
	...
	function _tableau(&$pdf, $tab_top, $tab_height, $nexY, $outputlangs, $hidetop=0, $hidebottom=0, $currency='')
	{
		...
		if (empty($hidetop))
		{
			...
			$pdf->MultiCell(78,2, $outputlangs->transnoentities("Designation"),'','L');
		}
